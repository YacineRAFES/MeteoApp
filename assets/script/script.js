...
async function meteo(){
    // const meteoActuelle = document.getElementById('meteoActuelle');
    // const meteoJournee = document.getElementById('meteoJournee');
    // const meteoSemaine = document.getElementById('meteoSemaine');
    // output.innerHTML = '';
    // output2.innerHTML = '';
    // actuel.innerHTML = '';
    //
